...
public class CustomActionTable4 implements CustomNodeAction {
	@Inject
	...
	public void run(CustomNodeActionContext ctx) {
		try {
			...
			_log.info("Custom action table 3");
			...
			_log.info("Movement to camera_detection_tables for Table3");
			...
			_log.info("Start platform positioning for Table3");
			...
			_log.info("Start photocatalysis.Table3_main");
			RemoteTaskId taskId2 = new RemoteTaskId("photocatalysis.Table3_main");
